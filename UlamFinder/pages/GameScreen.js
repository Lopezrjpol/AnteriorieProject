...
export default class GameScreen extends React.Component {
  ...
  showFood1 = () => {
    ...
    this.setState({ urlFood1:this.getImage(random1),
                    disabled1: true,
  ...
  showFood2 = () => {
    ...
    this.setState({ urlFood2:this.getImage(random2),
                    disabled2: true,
                    count: this.state.count + 1, 
                 });        
    this.showScore();
  ...
  showFood3 = () => {
    ...
    this.setState({ urlFood3:this.getImage(random3),
                    disabled3: true,
                    count: this.state.count + 1, 
                });
    this.showScore();
  ...
  showFood4 = () => {
    ...
    this.setState({ urlFood4:this.getImage(random4),
                    disabled4: true,
                    count: this.state.count + 1, 
                });
    this.showScore();
  ...
  showFood5 = () => {
    ...
    this.setState({ urlFood5:this.getImage(random5),
                    disabled5: true,
                    count: this.state.count + 1, 
                });
    this.showScore();
  ...
  showFood6 = () => {
    ...
    this.setState({ urlFood6:this.getImage(random6),
                    disabled6: true,
                    count: this.state.count + 1, 
                 });
    this.showScore();
         ...
         <View style={styles.topRightScore}>
          ...
          <View style={styles.container}>
            ...
            <Modal transparent = {true} visible = {this.state.scoreBoard}>
              <View style = {styles.modalContainer}>
                  ...
                  <View style = {{backgroundColor: "#660000", margin: 50,  padding:40, borderRadius:20, flex: 1}}>
                      <Text style={styles.topText}>{this.state.message} {totalPoints}</Text>
                        <Image style={{height: 120, width: 120, alignSelf: 'center'}} source={require("./images/coins.webp")}></Image>
          ...
          <View style= {styles.boxesRow}>
            <View style= {styles.boxesSpace}>
              <TouchableOpacity disabled={this.state.disabled1} onPress={this.showFood1}>
                <Image style={styles.boxesImage} source={this.state.urlFood1}/>
              </TouchableOpacity>
            </View>
            
            <View style= {styles.boxesSpace}>
              <TouchableOpacity disabled={this.state.disabled4} onPress={this.showFood4}>
          ...
          <View style= {styles.boxesRow}>
            <View style= {styles.boxesSpace}>
              <TouchableOpacity disabled={this.state.disabled2} onPress={this.showFood2}>
                <Image style={styles.boxesImage} source={this.state.urlFood2}/>
              </TouchableOpacity>
            </View>

            <View style= {styles.boxesSpace}>
              <TouchableOpacity disabled={this.state.disabled5} onPress={this.showFood5}>
          ...
          <View style= {styles.boxesRow}>
            <View style= {styles.boxesSpace}>
              <TouchableOpacity disabled={this.state.disabled3} onPress={this.showFood3}>
                <Image style={styles.boxesImage} source={this.state.urlFood3}/>
              </TouchableOpacity>
            </View>

            <View style= {styles.boxesSpace}>
              <TouchableOpacity disabled={this.state.disabled6} onPress={this.showFood6}>
